...
const Signup = () => {
  ...
  // Redirect to dashboard if user is already logged in (after Google redirect)
  useEffect(() => {
    if (currentUser) {
      navigate('/dashboard');
    }
    ...
    <div className="min-h-screen w-full relative flex items-center justify-center px-4">
      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-[#251b18] mb-2">Create Account</h2>
          <p className="text-gray-600">Join DAG GPT and start creating</p>
        </div>
