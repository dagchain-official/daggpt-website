...
const ChatInput = () => {
  ...
  const handleSubmit = () => {
    if (inputValue.trim()) {
      ...
      // Navigate to dashboard with prompt data
      navigate('/dashboard', { 
        state: { 
          prompt: inputValue,
  ...
  return (
    <StyledWrapper>
      <div className="container_chat_bot">
          ...
          <div className="chat">
            ...
            <div className="options">
              <div className="btns-add">
                <button onClick={handleFileAttach} title="Attach files">
                ...
                <button onClick={handleImageGeneration} title="Generate image">
                ...
                <button onClick={handleWebSearch} title="Web search">
                  <svg viewBox="0 0 24 24" height={20} width={20} xmlns="http://www.w3.org/2000/svg">
                ...
                <VoiceInputButton 
                  onTranscript={(text) => setInputValue(inputValue + text)}
                  className=""
                />
              </div>
              <button className="btn-submit" onClick={handleSubmit} disabled={!inputValue.trim()}>
                <i>
        ...
        />
        <div className="tags">
          <span onClick={() => handleTagClick('Create an image of ')}>Create An Image</span>
          <span onClick={() => handleTagClick('Analyse this data: ')}>Analyse Data</span>
          <span onClick={() => handleTagClick('')}>More</span>
        </div>
      </div>
    </StyledWrapper>
  );
